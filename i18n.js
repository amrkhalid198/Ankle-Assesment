...
const I18n = {
  strings: {
    ...
    // Insights per tier
    // ==========================================
    'insight.severe': 'النتائج بتاعتك بتبين إن عندكالنتائج بتاعتك بتوضح إن عندك عدم ثبات واضح (Significant Instability). الكاحل عندك حاليًا مش بيستجيب أو يثبت ويمتص الضغط (Force) بالمستوى المطلوب للأداء الرياضي الآمن.\n\nالموضوع مش قوة عضلية (Strength) بس — الجهاز العصبي (Nervous System) فقد جزء كبير من قدرته على حماية المفصل وقت الحركات المفاجئة والسريعة. وده نمط شائع في حالات Chronic Ankle Instability المتقدمة.\n\nالرياضيين في المرحلة دي بيكونوا معرضين بنسبة عالية لإصابات جديدة (High Risk) لو رجعوا للرياضة من غير Rehab Protocol منظم ومتدرج.',
    
    'insight.moderate': 'الـ Balance عندك في مستوى معقول، بس الـ Reactive Stability والـ Confidence وقت الهبوط بيبينوا إن الـ Ankle ممكن يخونك وقت الـ Cutting المفاجئ.\n\nده نمط بيحصل كتير في Chronic Ankle Instability (CAI) — المفصل اتحسن كـ Structure بس الـ Nervous System لسه ما اتعلمش يحميه بالكامل.\n\nالرياضيين هنا بيحسوا إنهم \"تمام\" في الجري العادي، بس بيلاحظوا الـ Instability وقت الماتشات. الخطر هنا تراكمي، كل مرة المفصل بيفلت بتقوي نفس النمط.',
    
    'insight.mild': 'الـ Ankle بتاعك كـ Baseline ممتاز، بس فيه Deficits خفيفة ممكن تأثر عليك تحت الـ High-intensity.\n\nالأرقام القليلة عندك بتبين إن قدرة المفصل على الـ Reaction للحاجات المفاجئة لسه ماوصلتش لمستوى قوتك العضلية. كتير من الرياضيين في المرحلة دي بيتمرنوا كويس جدًا بس بيعانوا وقت الماتشات لما الـ Fatigue بيزيد.\n\nدي أكتر مرحلة الرياضيين بيعلقوا فيها — بيحسوا إنهم \"Good enough\" فمش بيكملوا التأهيل للآخر.',
    
    'insight.optimal': 'الـ Ankle بتاعك أرقامه ممتازة في كل الاختبارات. الـ Stability، الثقة، والقدرة البدنية جاهزين تمامًا للملعب.\n\nده مش معناه إنك توقف شغل — الرياضيين اللي بيكملوا من غير إصابات هما اللي بيخلوا الـ Reactive Stability جزء من الـ Warm-up بتاعتهم.\n\nكمل في التمارين اللي بتعمل Challenge للـ Ankle عشان تحافظ على الـ Baseline ده.',
